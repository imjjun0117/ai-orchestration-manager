...
| MB-011 operations | `!team`, `!health`, `!roles`, `!instance`, approval usage feedback, outbox response | command tests; live missing-reason rejection feedback and bound rejection completed |
